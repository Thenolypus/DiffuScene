...
exp_dir="../dataset/pretrained_diffusion"
...
threed_future='../dataset/3d_front_processed/threed_future_model_diningroom.pkl'
...
threed_future='../dataset/3d_front_processed/threed_future_model_livingroom.pkl'
